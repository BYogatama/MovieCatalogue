/*
 * Created by Bagus Yogatama on 7/20/19 7:58 PM
...
import com.lonedev.favouriteapp.ui.adapter.VideoAdapter
...
class TVSeriesDetailActivity : BaseActivity() {
    ...
    companion object {
        fun generateIntent(context: Context?, tvSeriesResult: TVSeriesResult?): Intent {
            return Intent(context, TVSeriesDetailActivity::class.java).apply {
