...
package com.lonedev.favouriteapp.ui.details.movie
...
import com.lonedev.favouriteapp.data.repositories.MovieRepository
...
class MovieDetailViewModel @Inject constructor(
    ...
    fun deleteFavourites(context: Context, movieId: Int) {
        ...
        favoriteRepository.deleteMovieFavourites(movieId)
            .subscribeOn(Schedulers.io())
