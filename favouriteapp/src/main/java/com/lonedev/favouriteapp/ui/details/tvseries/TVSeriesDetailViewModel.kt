/*
 * Created by Bagus Yogatama on 7/20/19 8:02 PM
 * Copyright (c) 2019 . All rights reserved.
 * Last modified 7/20/19 7:36 PM
 */

package com.lonedev.favouriteapp.ui.details.tvseries
...
import com.lonedev.favouriteapp.data.repositories.TVSeriesRepository
...
@Inject constructor(
    ...
    fun deleteFavourites(context: Context, tvSeriesId: Int) {
        ...
        favoriteRepository.deleteTVFavourites(tvSeriesId)
            .subscribeOn(Schedulers.io())
